    ...
    return (
      <article className="wp-template-page">
        <Hero
          ...
          intro="Our safari specialists are already hard at work designing your perfect African adventure."
        ...
        <section className="py-section-md">
          <Container maxWidth="narrow">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-serif font-semibold mb-6">What's Next?</h2>
              <div className="space-y-8 text-left mb-12">
                <div className="flex gap-4 p-6 rounded-xl bg-card border border-border">
                  ...
                  <div>
                    <h4 className="font-bold">Personalized Proposal</h4>
  ...
  return (
    <article className="wp-template-page">
      ...
      <Hero
        ...
        intro="Receive a personalized, obligation-free itinerary and comprehensive quote within 24 business hours."
        image="https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800"
        height="medium"
        overlay="medium"
      />
      ...
      <StatisticsMetricsPattern
        statistics={[
          ...
          { value: "250+", label: "Quotes This Month", icon: CheckCircle },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <div className="lg:col-span-2">
              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                <div className="space-y-6">
                  <h3 className="text-lg font-serif font-bold pb-2 border-b border-border/50">Personal Details</h3>
                ...
                <div className="space-y-6">
                  <h3 className="text-lg font-serif font-bold pb-2 border-b border-border/50">Trip Vision</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium">Estimated Departure</label>
                ...
                >
                  {isSubmitting ? <Loader2 className="animate-spin" /> : "Request My Free Quote"}
                </Button>
              </form>
            </div>
            ...
            <aside className="space-y-10">
              <div className="p-8 rounded-2xl bg-muted/30 border border-border/50">
                <h3 className="text-xl font-serif font-bold mb-6">Why Request a Quote?</h3>
                <ul className="space-y-6 list-none p-0 m-0">
                  <li className="flex gap-3 m-0">
                    <CheckCircle size={20} className="text-primary shrink-0 mt-1" />
                    <div>
                      <p className="font-bold text-sm">No Obligation</p>
                  ...
                  <li className="flex gap-3 m-0">
                    <CheckCircle size={20} className="text-primary shrink-0 mt-1" />
                    <div>
                      <p className="font-bold text-sm">Expert Optimization</p>
              ...
              <div className="p-8 rounded-2xl bg-primary text-primary-foreground relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <h3 className="text-xl font-serif font-bold mb-4">Prefer to Speak?</h3>
                  <p className="text-sm opacity-90 mb-6">Our consultants are available for a one-on-one discovery call.</p>
                  <a href="tel:+27211234567" className="text-lg font-bold block mb-2 hover:underline">+27 21 123 4567</a>
